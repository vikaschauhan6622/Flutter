...
class CustomTextSquareScreen extends StatefulWidget {
  const CustomTextSquareScreen({Key? key}) : super(key: key);

  @override
  _CustomTextSquareScreenState createState() => _CustomTextSquareScreenState();
}

class _CustomTextSquareScreenState extends State<CustomTextSquareScreen>
                    ...
                    Container(
                      child: GridView.count(
                        ...
                        children: [
                          ...
                          gridThumbnail(whiteColor),
                          gridThumbnail(blackColor),
                          gridThumbnail(redColor),
                          gridThumbnail(codeColor),
                          gridThumbnail(greyColor),
                          gridThumbnail(numberColor),
                          gridThumbnail(splashGradientOne),
                          gridThumbnail(splashGradientTwo),
                        ],
                      ),
                    ),
                    Container(
